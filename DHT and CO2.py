...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        print('Next update')
        temp=25+random.randrange(1,150)/10
        hum=68+random.randrange(1,40)/10
        co2=18+random.randrange(1,40)/10
        current_data='>> Temperature: '+str(temp)+', Humidity: '+str(hum)+', Co2 Concentration: '+str(co2)
        self.connectionDock.Temperature.setText(str(temp))
        self.connectionDock.Humidity.setText(str(hum))
        self.connectionDock.Co2.setText(str(co2))
